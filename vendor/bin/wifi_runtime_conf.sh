...
function MTK_NV_SET() {
	...
	#log -p i -t $LOG_TAG "WIFI_SKU_PATH  : ${WIFI_SKU_PATH}"
	#log -p i -t $LOG_TAG "WIFI_MTK_FW_PATH  : ${WIFI_MTK_FW_PATH}"
	#log -p i -t $LOG_TAG "WIFI_MTK_CACHE_BOOT_CAL_FILE  : ${WIFI_MTK_CACHE_BOOT_CAL_FILE}"
	#log -p i -t $LOG_TAG "WIFI_MTK_CACHE_WMT_SOC_FILE  : ${WIFI_MTK_CACHE_WMT_SOC_FILE}"
	STEP=1
...
# Not used in P OS.
# [Notice] If you use /device/lge/{model}/wlan/common/conf/wifi_runtime_prop.conf, you should restore this function!!
